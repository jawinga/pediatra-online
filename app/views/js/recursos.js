...
<div class="blog-inferior">
  ...
  <div class="blog-normal__categoria">
...
<path class="st0" d="M470.097,138.553h-36.312h-18.404c-21.106,0-40.432,11.831-50.033,30.622l-33.494,97.967
  ...
  <span class="blog-normal__categoria__nombre">${categoria}</span>


  </div>

  <h2 class="blog-normal__titulo">${titulo}
