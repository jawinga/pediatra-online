...
--
-- Servidor: localhost
-- Tiempo de generación: 19-05-2025 a las 16:45:39
...
CREATE TABLE `citas` (
  ...
  `centro_medico` varchar(255) NOT NULL,
...
INSERT INTO `citas` (`id`, `usuario_id`, `hijo_id`, `fecha`, `tipo_vacuna`, `centro_medico`, `titulo`) VALUES
(1, 6, 13, '2025-05-17 03:12:00', 'Triple Vírica', 'Clínica Quirón Málaga', 'Vacuna: Triple Vírica'),
(2, 6, 13, '2025-05-16 08:07:00', 'Triple Vírica', 'Hospital Universitario del Henares', 'Vacuna: Triple Vírica'),
(3, 8, 14, '2025-06-03 19:04:00', 'Hexavalente', 'Hospital Universitario del Tajo', 'Vacuna: Hexavalente');
...
CREATE TABLE `contacto` (
  `nombre_contactForm` varchar(100) NOT NULL,
  `email_contactForm` varchar(100) NOT NULL,
  `asunto_contactForm` varchar(100) NOT NULL,
  `mensaje_contactForm` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `contacto` (`nombre_contactForm`, `email_contactForm`, `asunto_contactForm`, `mensaje_contactForm`) VALUES
('paquito', 'paquit0@gmail.com', 'dudas', 'dawdwdwadwadawd'),
('paquito', 'paquit0@gmail.com', 'dudas', 'dawdwdwadwadawd'),
('paquito', 'paquit0@gmail.com', 'dudas', 'dawdwdwadwadawd'),
('paquito', 'paquit0@gmail.com', 'dudas', 'dawdwdwadwadawd'),
('paquito', 'paquit0@gmail.com', 'dudas', 'dawdwdwadwadawd'),
...
(13, 6, 'ufyf', '2025-05-15', 'F', 'avatar-5.png'),
(14, 8, 'elena', '2019-02-03', 'F', 'avatar-1.png');
...
(8, 'Eduardo', 'Prieto Cañada', 'eduardoprtcnd@gmail.com', '$2y$10$DtDpIQ83MYXKgAnDkGLVQeLa1t4eusQVEjGVF5z6bADsBxOUtffQ6', 'default.png', '2025-05-16 14:51:28');
...
--
ALTER TABLE `citas`
  ADD CONSTRAINT `citas_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `citas_ibfk_2` FOREIGN KEY (`hijo_id`) REFERENCES `hijos` (`id`) ON DELETE CASCADE;
